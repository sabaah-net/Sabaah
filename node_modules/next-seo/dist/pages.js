...
__export(pages_exports, {
  generateDefaultSeo: () => generateDefaultSeo,
  generateNextSeo: () => generateNextSeo
});
...
var generateSeoTags = (config) => {
  ...
  if (updatedTitle) {
    tagsToRender.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: updatedTitle }, "title"));
  }
  ...
  if (config.themeColor) {
    tagsToRender.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("meta", { name: "theme-color", content: config.themeColor }, "theme-color")
    );
  }
  ...
  if (config.openGraph) {
    ...
    if (config.openGraph.type) {
      ...
      tagsToRender.push(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("meta", { property: "og:type", content: type }, "og:type")
      );
  ...
  if (config.canonical) {
    tagsToRender.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("link", { rel: "canonical", href: config.canonical }, "canonical")
    );
  }
