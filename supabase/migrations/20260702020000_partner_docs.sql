...
drop policy if exists "Public can read partner docs" on storage.objects;
...
drop policy if exists "Authenticated users can upload partner docs" on storage.objects;
